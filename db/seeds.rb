...
# service/gratitude
Mission.create!(name: 'Do the dishes for your family (max: 10)', points: 5, category: ser, limit: 10)
...
Mission.create!(name: 'Take care of an errand for your family (max: 10)', points: 5, category: ser, limit: 10)
...
Mission.create!(name: 'Do the laundry for your family (max: 10)', points: 5, category: ser, limit: 10)
Mission.create!(name: 'Learn a new dish (post a picture!)', points: 10, category: ser)
Mission.create!(name: 'Vacuum the house (max: 10)', points: 5, category: ser, limit: 10)
...
Mission.create!(name: 'Exercise for at least 30 minutes (max: 10 of these entries per person)', points: 5, category: equ, limit: 10)
